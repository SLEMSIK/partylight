...
export const PRODUCTS: Product[] = [
  ...
  // Screen products (1 item)
  {
    ...
    longDescription: 'Модульный LED экран высокого разрешения P2.9 для внутренних мероприятий. Яркость 1200 cd/m², возможность сборки любой конфигурации. Включает видео процессор, коммутацию и монтажные конструкции. Идеально подходит для концертов, конференций, презентаций и крупных мероприятий.',
  ...
  },
  {
    ...
    longDescription: 'Информация о конструкции: Монолитные тотемы высотой от 1 до 4 метров.\nКогда лучше использовать: Зонирование, оформление, брендирование.\nЭффект: Стильное оформление пространства.',
